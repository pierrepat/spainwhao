        ...
        <div className="mx-auto max-w-lg px-6">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded bg-[#25D366] px-8 py-3 font-sans text-sm font-medium text-white transition-colors hover:bg-[#1fb855]"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded border border-line px-8 py-3 font-sans text-sm font-medium text-ink transition-colors hover:border-sage hover:text-sage"
            >
